    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className="fixed top-[13%] right-[3%] z-10 border rounded-full w-12 flex justify-center bg-slate-100 cursor-pointer">
            <FaShare
          ...
          {copied && (
            <p className="fixed top-[23%] right-[5%] z-10 rounded-md bg-slate-100 p-z">
              Link copied!
            </p>
          )}
