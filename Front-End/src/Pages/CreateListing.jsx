      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1">
          ...
          <button
            ...
            className="p-5 text-sm py-4 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80"
          >
            ...
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-2 text-red-600 rounded-lg uppercase hover:shadow-md border border-black "
                >
                  Delete
                </button>
              </div>
